            ...
            <div className="flex flex-col md:flex-col lg:flex-row">
                <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">
                    ...
                    <h3 className="font-bold text-lg flex items-center"><img
                        ...
                        className="w-16 h-16"
                    /> Goldencloud Tours</h3>
                    <p className="text-gray-400">Feel free to drop by and lets have a chat </p>
                ...
                <div className="w-full lg:w-2/6 mt-8 lg:mt-0 lg:mx-4">
                    ...
                    <ul className="mt-4">
                        ...
                        <li  className="mt-2 opacity-75 hover:opacity-100">Booking</li>
                ...
                <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                    ...
                    <ul className="mt-4 flex">
                        ...
                        <li className="ml-6">
                            <a href="www.twitter.com" target="_blank" title="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
                                    <path
                        ...
                        <li className="ml-6">
                            <a href="www.instagram.com" target="_blank" title="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
                                    <path
                        ...
                        <li className="ml-6">
                            <a href="www.youtube.com" target="_blank" title="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current">
                                    <path
